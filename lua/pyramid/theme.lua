...
function M.setup(config)
  ...
  theme.base = {
    ...
    Constant = { fg = c.banana },
    String = { fg = c.matcha },
    Character = { fg = c.sage },
    Number = { fg = c.frappe },
    Boolean = { fg = c.pink },
    Float = { fg = c.frappe },
    Identifier = { fg = c.foreground, style = config.variable_style },
    Function = { fg = c.banana },
    Statement = { fg = c.error_red },
    Conditional = { fg = c.maroon },
    Repeat = { fg = c.pink },
    Label = { fg = c.mango },
    Operator = { fg = c.comment },
    Keyword = { fg = c.maroon, style = config.keyword_style },
    ...
    Typedef = { fg = c.banana },
    Special = { fg = c.comment, style = "italic" },
    ...
    LineNr = { fg = c.comment },
    MatchParen = { bg = c.none, style = "underline" },
    ...
    StatusLine = { fg = c.foreground, bg = c.none },
    StatusLineNC = { fg = c.none },
    StatusLineTerm = { fg = c.foreground, bg = c.none },
    StatusLineTermNC = { fg = c.none },
    ...
    TSConstant = { fg = c.matcha, style = "bold" },
    TSConstBuiltin = { fg = c.louis_bleu },
    TSString = { fg = c.mango, style = "nocombine" },
    ...
    TSConditional = { fg = c.maroon },
    TSRepeat = { fg = c.maroon },
    TSLabel = { fg = c.mango },
    TSKeyword = { fg = c.louis_bleu, style = "bold" },
    TSKeywordFunction = { fg = c.comment, "bold" },
    TSKeywordOperator = { fg = c.comment },
    TSOperator = { fg = c.comment },
    TSException = { fg = c.purple },
    TSType = { fg = c.banana },
    TSTypeBuiltin = { fg = c.banana },
    ...
    Visual = { bg = c.highlight, style = "bold" }, --visual mode (highlighting)
    ...
    CmpItemKindProperty = { fg = c.matcha, bg = c.none },
    CmpItemKindField = { fg = c.matcha, bg = c.none },
    CmpItemKindTypeParameter = { fg = c.matcha, bg = c.none },
    CmpItemKindEnumMember = { fg = c.matcha, bg = c.none },
    CmpItemKindOperator = { fg = c.matcha, bg = c.none },
